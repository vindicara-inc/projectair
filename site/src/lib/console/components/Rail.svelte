<script lang="ts">
  ...
  const pillars = [
    { tag: 'M', accent: '#6db5ff', label: 'Monitor', value: '16 + SV', sub: 'detectors + structural verification', to: '/dashboard/' },
    { tag: 'E', accent: '#ff5d68', label: 'Enforce', value: 'deterministic', sub: "floor that can't be jailbroken", to: '/dashboard/readiness/' },
  ];
  const pillarsLower = [
    { tag: 'P', accent: '#48e6a4', label: 'Prove', value: 'Rekor', sub: 'anchored 41s ago · ml-dsa-65', to: '/dashboard/readiness/' },
    { tag: 'A', accent: '#9b6bff', label: 'Account', value: '94%', sub: 'agents bound to a human', to: '/dashboard/' },
  ];
</script>

<aside class="rail glass hud k reveal">
  <div class="rhead"><span class="dot"></span><span class="logo">Project&nbsp;<span class="air">AIR</span></span><span class="rtag">flightdeck</span></div>

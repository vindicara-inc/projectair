<script lang="ts">
  ...
  function handleEnter(e: MouseEvent) {
    ...
    el.style.backgroundColor = 'var(--glass)';
  }
...
<div class="mt-16 pt-8" style="border-top: 1px solid var(--border-subtle);">
  <p class="font-mono text-[10px] uppercase tracking-[0.18em] mb-4" style="color: var(--text-muted);">Share</p>
  <div class="flex flex-wrap gap-2">
    <a href={linkedin} target="_blank" rel="noopener noreferrer" aria-label="Share on LinkedIn"
       class="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition-all"

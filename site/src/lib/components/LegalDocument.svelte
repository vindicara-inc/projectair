...
<main class="pt-24 pb-20 px-6">
  <article class="max-w-3xl mx-auto legal-content leading-relaxed" style="color: var(--text-secondary);">
    {@html html}
  </article>
</main>
...
<footer class="w-full relative z-20" style="border-top: 1px solid var(--border-subtle); background-color: var(--surface);">
  <div class="max-w-screen-xl mx-auto px-6 py-14">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
      <div class="col-span-2 md:col-span-1">
        <div class="flex items-center gap-1 mb-4">
          <img src={vindicaraLogoNight} alt="Vindicara" class="h-8 w-auto logo-night mix-blend-screen" /><img src={vindicaraLogoDay} alt="Vindicara" class="h-8 w-auto logo-day" />
          <span class="font-mono text-[10px] tracking-[0.18em] uppercase px-1.5 py-0.5" style="color: var(--text-primary); border: 1px solid var(--border); box-shadow: 0 0 10px var(--badge-shadow);">Project AIR&#8482;</span>
        </div>
      ...
      <div>
        <h3 class="text-sm font-semibold mb-4" style="color: var(--text-primary);">Product</h3>
      ...
      <div>
        <h3 class="text-sm font-semibold mb-4" style="color: var(--text-primary);">Company</h3>
        <ul class="space-y-2 text-sm" style="color: var(--text-muted);">
      ...
      <div>
        <h3 class="text-sm font-semibold mb-4" style="color: var(--text-primary);">Legal</h3>
        <ul class="space-y-2 text-sm" style="color: var(--text-muted);">
    ...
    <div class="mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4" style="border-top: 1px solid var(--border-subtle);">

...
<nav class="fixed top-0 w-full z-50 bg-obsidian/60 backdrop-blur-2xl border-b border-white/5">
  <div class="max-w-screen-2xl mx-auto px-6 flex items-center justify-between h-16">
    ...
    <div class="hidden md:flex items-center gap-3">
      <a href="https://github.com/vindicara-inc/projectair" class="btn-secondary text-xs px-4 py-2">
  ...
  {#if mobileMenuOpen}
    <div class="md:hidden border-t border-white/5 bg-obsidian/95 backdrop-blur-2xl px-6 py-4 space-y-3">
      ...
      <div class="flex gap-3 pt-2">
        <a href="https://github.com/vindicara-inc/projectair" class="btn-secondary text-xs px-4 py-2">GitHub</a>
        <a href="https://d1xzz26fz4.execute-api.us-east-1.amazonaws.com/docs" class="btn-primary text-xs px-4 py-2">Get API Key</a>
      </div>
    </div>
  {/if}
  ...
  <div class="max-w-screen-xl mx-auto px-6 py-16">
    <div class="grid grid-cols-2 md:grid-cols-5 gap-8">
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm text-zinc-500">
          <li><a href="mailto:support@vindicara.io" class="hover:text-white transition-colors">Contact</a></li>
          <li><a href="https://github.com/vindicara-inc/projectair" class="hover:text-white transition-colors">GitHub</a></li>
          <li><a href="https://x.com/AIRbyVindicara" class="hover:text-white transition-colors">Twitter / X</a></li>
        </ul>
      </div>
    ...
    <div class="mt-8 flex flex-col md:flex-row items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-4">
        ...
        <a href="https://x.com/AIRbyVindicara" class="text-zinc-600 hover:text-white transition-colors">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
        </a>
        <a href="https://linkedin.com/company/vindicara-ai" class="text-zinc-600 hover:text-white transition-colors">

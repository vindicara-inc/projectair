...
<main class="min-h-screen" style="background-color: var(--surface); color: var(--text-primary);">
  <section class="mx-auto max-w-4xl px-6 pt-20 pb-12">
    <div class="mb-8 flex items-center gap-3">
      <span class="inline-block h-2 w-2 rounded-full bg-green-400"></span>
      <span class="font-mono text-xs uppercase tracking-widest" style="color: var(--text-muted);">live</span>
      <span class="font-mono text-xs" style="color: var(--text-muted);">|</span>
      <span class="font-mono text-xs" style="color: var(--text-muted);">vindicara ops chain</span>
    </div>
    ...
    <p class="mb-8 max-w-2xl text-lg" style="color: var(--text-secondary);">
    ...
    <div class="dark-embed rounded-lg p-6 font-mono text-sm">
      {#if manifest}
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
          <div>
            <div class="mb-1 text-xs uppercase tracking-widest" style="color: var(--text-muted);">latest rekor log index</div>
            <div class="text-2xl font-bold text-cyan-400">{manifest.latest_rekor_log_index.toLocaleString()}</div>
          </div>
          <div>
            <div class="mb-1 text-xs uppercase tracking-widest" style="color: var(--text-muted);">verify on Sigstore</div>
            <a
        ...
        <div class="mt-4 pt-4 text-xs text-zinc-500" style="border-top: 1px solid rgba(255,255,255,0.1);">
    ...
    <div class="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
      <div class="glass-panel rounded-lg p-5">
        <div class="mb-2 text-xs uppercase tracking-widest" style="color: var(--text-muted);">trust model</div>
      ...
      <div class="glass-panel rounded-lg p-5">
        <div class="mb-2 text-xs uppercase tracking-widest" style="color: var(--text-muted);">redaction policy</div>
        <p class="text-sm" style="color: var(--text-secondary);">
    ...
    <div class="mt-10 text-sm" style="color: var(--text-muted);">
      Source:
      <a

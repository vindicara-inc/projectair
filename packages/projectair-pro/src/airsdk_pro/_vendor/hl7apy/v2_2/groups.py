...
GROUPS = {
    ...
    'MFR_M02_MF_STAFF': ('sequence',
                         (['MFE', SEGMENTS['MFE'], (1, 1), 'SEG'],
                          )),
    'MFR_M03_MF_TEST': ('sequence',
                        (['MFE', SEGMENTS['MFE'], (1, 1), 'SEG'],
                         )),
    'NMD_N01_APP_STATS': ('sequence',
                          (['NST', SEGMENTS['NST'], (1, 1), 'SEG'],
                           ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],)),
    'NMD_N01_APP_STATUS': ('sequence',
                           (['NSC', SEGMENTS['NSC'], (1, 1), 'SEG'],
                            ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],)),
    'NMD_N01_CLOCK': ('sequence',
    ...
    'NMQ_N02_QRY_WITH_DETAIL': ('sequence',

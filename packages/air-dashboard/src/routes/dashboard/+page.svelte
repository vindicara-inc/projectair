...
<div class="relative z-[2] min-h-screen pt-16 pb-20 px-16 max-w-[1600px] mx-auto grid grid-cols-[320px_1fr_320px] gap-8 items-start" style="font-family: var(--font-mono);">

...
**Public proof point:** the Wave 1 demo's validation attestation is anchored on the public Sigstore Rekor at log index **1457501438** (https://search.sigstore.dev/?logIndex=1457501438). The entry contains hashed identifiers only — auditors with chain access can resolve the hashes to cleartext; the public log reveals no agent topology.
